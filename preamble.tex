...
\usepackage{multibib}		% So we can have a recommended-reading bib
...
%%             [hang]					% Shape
%%             {\huge\sffamily\color{myRed}}		% format
%%             {Part \thepart:}				% label
%%             {0.5em}					% sep
%%             {}						% before
%%             {}						% after
...
\titleformat*{\section}					% command
             {\needspace{1in}\Large\sffamily\color{myRed}}		% format
